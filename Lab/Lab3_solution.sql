...
select count(*)
from   Accesses
where  page like '%messageboard%' and page ilike 'webcms%' and params like '%state=search%';
...
-- Q9: "sessions" which have no page accesses

create or replace view Q9(session) as
select id
from   Sessions s
